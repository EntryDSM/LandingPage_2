        ...
        <Center>
          <FirstImg>
            <div align="right">
              ...
              <Title>새로운 시작</Title>
              <Contents>
                초대 교장선생님이신 최부영 선생님의 권유로 시작된 EntryDSM은
                2016년 v1을 출시하여 학생들이 프로덕션 환경의 시스템을 구현하고
                운영하는 데 있어 전반적인 기반을 다졌습니다.
              </Contents>
            </div>
            <Img>
              <img src={img2016} width="165" height="165" alt="img" />
            </Img>
          </FirstImg>
          <Next>▼</Next>
          <Right>
            <div>
              <Img>
                <img src={img2017} width="165" height="165" alt="img" />
              </Img>
            </div>
            <div>
              <Year>2017</Year>
              ...
              <Contents>
                v1에서 수많은 학생과 교사분들께 받았던 피드백을 바탕으로 서비스
                품질을 개선하기 위해 매진하였고, 이에 아키텍처 설계를 고려하는
                등 안정적인 시스템을 구현할 수 있도록 노력했습니다.
              </Contents>
            </div>
          </Right>
          <Next>▼</Next>
          <Flex>
            <div align="right">
              ...
              <Contents>
                현업에서 자주 이용되는 기술 스택을 기반으로 시스템을 구성하여
                사용자 UI, 원서 출력 기능 등 다양한 기능들을 안정적 이용과 성능
                향상에 주력하여 시스템의 완성도를 높였습니다.
              </Contents>
            </div>
            <div>
              <Img>
                <img src={img2018} width="165" height="165" alt="img" />
              </Img>
            </div>
          </Flex>
          <Next>▼</Next>
          <Right>
            <div>
              <Img>
                <img src={img2019} width="165" height="165" alt="img" />
              </Img>
            </div>
            <div>
              <Year>2019</Year>
