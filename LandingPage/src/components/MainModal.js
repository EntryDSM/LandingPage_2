...
`;
// #3DFFEB (메인 컬러)
const MainModal = ({ setClickedNumber }) => {
    const onClick = (e) => {
        console.log(11);
                                    ...
                                    <div className="mx-auto">
                                        <div className="modal-body">
                                            ...
                                            <ul className="list-unstyled">
                                                ...
                                                <li>웹 프론트엔드 개발: 오준상 이우찬</li>
                                                <li>백엔드 개발: 김재훈 황신우 임용성</li>
                                            </ul>
                                            <button className="modalBtn" data-id="" onClick={onClick}>프로젝트 닫기</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
